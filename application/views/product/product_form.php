...
<!-- Page Heading --> <h2 style="margin-top:0px">Product <?php echo $button ?></h2>
<!-- DataTales Example -->
<div class="card shadow mb-4">
    ...
    <div class="card-body">
	    ...
	    <div class="form-group">
            <label for="varchar">Kd Kategori <?php echo form_error('kd_kategori') ?></label>
            <input type="text" class="form-control" name="kd_kategori" id="kd_kategori" placeholder="Kd Kategori" value="<?php echo $kd_kategori; ?>" />
        </div>
	    <div class="form-group">
